...
func http_post()  {
	...
	request, _ := http.NewRequest("POST", configParameters["apiUrl"]+"/v2/heartbeats/"+parameters["name"]+"/ping", body)
	request.Header.Add("Authorization", "GenieKey "+parameters["apiKey"])
